	...
	private render(): void {
		...
		for (const highlight of this.highlights) {
			...
			if (pos < highlight.start) {
				...
				children.push(dom.$('span', undefined, ...this.supportCodicons ? renderLabelWithIcons(substring) : [substring]));
				pos = highlight.end;
			}

			const substring = this.text.substring(highlight.start, highlight.end);
			const element = dom.$('span.highlight', undefined, ...this.supportCodicons ? renderLabelWithIcons(substring) : [substring]);
